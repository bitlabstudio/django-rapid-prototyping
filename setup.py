"""
Python setup file for the rapid_prototyping app.
...
rapid_prototyping/__init__.py and re-run the above command.
...
import rapid_prototyping as app
...
setup(
    ...
    url="https://github.com/bitmazk/django-rapid-prototyping",
